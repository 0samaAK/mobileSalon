...
const adjustPrice = () => {
  return (
    ...
    <div className="bg-gray-50 p-[40px] shadow-lg w-full max-w-[659px] relative">
      {/* Close button */}
      ...
      {/* Title */}
      <h2 className="text-[32px] font-[600] text-[#6D6D6D] mb-2 figtree-font">Session Type</h2>
      <p className="text-[#A0A0A0] text-[24px] font-[600] mb-4 figtree-font">Current Price - $190</p>
      ...
      <div className="flex items-center bg-gray-100 border border-[#A0A0A0] rounded px-3 py-2 mb-[24px]">
        <input
          ...
          className="flex-1 bg-transparent outline-none placeholder-[#B8B8B8]  figtree-font placeholder:text-[16px] placeholder:font-[600]"
        />
